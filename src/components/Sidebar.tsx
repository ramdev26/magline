    ...
    <aside className="w-64 h-screen bg-slate-900 text-white flex flex-col border-r border-slate-800">
      ...
      <div className="p-6 bg-slate-800 mt-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <p className="text-xs font-semibold truncate max-w-[140px]">{user?.name}</p>
        ...
        <button
          ...
          className="flex items-center gap-3 text-sm text-slate-400 hover:text-white w-full transition-colors"
        >
          <LogOut size={16} />
          Logout
        </button>
